...
namespace ADAssessment.Tests.WebAPI.Fakes
{
    ...
    internal sealed class FakeLdapDataExtractor : ILdapDataExtractor
    {
        ...
        private readonly IReadOnlyList<AdTrustRelationship>? _trusts;
        ...
        private readonly Exception? _trustExceptionToThrow;

        public static FakeLdapDataExtractor Returning(IReadOnlyList<AdUserAccount> users, IReadOnlyList<AdComputerAccount>? computers = null, DcSyncRightsSettings? dcSyncRights = null, DomainFunctionalLevelSettings? domainFunctionalLevel = null, ForestOptionalFeatureSettings? forestFeatures = null, IReadOnlyList<AdTrustRelationship>? trusts = null) => new(users, computers, dcSyncRights, domainFunctionalLevel, forestFeatures, trusts, null, null, null, null, null, null);

        public static FakeLdapDataExtractor ThrowingOnConnect(Exception exception) => new(null, null, null, null, null, null, exception, null, null, null, null, null);
        ...
        /// </summary>
        public static FakeLdapDataExtractor ThrowingOnComputerQuery(IReadOnlyList<AdUserAccount> users, Exception exception) => new(users, null, null, null, null, null, null, exception, null, null, null, null);
        ...
        /// </summary>
        public static FakeLdapDataExtractor ThrowingOnDcSyncQuery(IReadOnlyList<AdUserAccount> users, Exception exception) => new(users, null, null, null, null, null, null, null, exception, null, null, null);
        ...
        /// test etmek için.
        /// </summary>
        public static FakeLdapDataExtractor ThrowingOnFunctionalLevelQuery(IReadOnlyList<AdUserAccount> users, Exception exception) => new(users, null, null, null, null, null, null, null, null, exception, null, null);
        ...
        /// </summary>
        public static FakeLdapDataExtractor ThrowingOnForestFeatureQuery(IReadOnlyList<AdUserAccount> users, Exception exception) => new(users, null, null, null, null, null, null, null, null, null, exception, null);

        /// <summary>
        /// GetActiveUsers başarılı dönerken GetTrustRelationships'ın hata fırlattığı durumu
        /// simüle eder - AssessmentController'daki trust sorgusu izolasyonunu test etmek için.
        /// </summary>
        public static FakeLdapDataExtractor ThrowingOnTrustQuery(IReadOnlyList<AdUserAccount> users, Exception exception) => new(users, null, null, null, null, null, null, null, null, null, null, exception);

        private FakeLdapDataExtractor(IReadOnlyList<AdUserAccount>? users, IReadOnlyList<AdComputerAccount>? computers, DcSyncRightsSettings? dcSyncRights, DomainFunctionalLevelSettings? domainFunctionalLevel, ForestOptionalFeatureSettings? forestFeatures, IReadOnlyList<AdTrustRelationship>? trusts, Exception? exceptionToThrow, Exception? computerExceptionToThrow, Exception? dcSyncExceptionToThrow, Exception? functionalLevelExceptionToThrow, Exception? forestExceptionToThrow, Exception? trustExceptionToThrow)
        {
            _users = users;
            ...
            _trustExceptionToThrow = trustExceptionToThrow;
        }
        ...
        public IReadOnlyList<AdTrustRelationship> GetTrustRelationships()
        {
            ...
            if (_trustExceptionToThrow != null)
            {
                throw _trustExceptionToThrow;
            }

            return _trusts ?? Array.Empty<AdTrustRelationship>();
        }
    }
}
